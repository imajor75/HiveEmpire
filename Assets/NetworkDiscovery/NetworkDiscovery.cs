...
public abstract class NetworkDiscovery<TBroadCast, TResponse> : HiveCommon
    ...
    where TResponse : INetworkSerializable, new()
{
    ...
    /// </summary>
    public bool IsDiscoveryServer { get; private set; }

    /// <summary>
    /// Gets whether the discovery is in client mode.
    /// </summary>
    public bool IsDiscoveryClient { get; private set; }
    ...
    void StartDiscovery(bool isServer)
    {
        ...
        IsDiscoveryServer = isServer;
        IsDiscoveryClient = !isServer;
